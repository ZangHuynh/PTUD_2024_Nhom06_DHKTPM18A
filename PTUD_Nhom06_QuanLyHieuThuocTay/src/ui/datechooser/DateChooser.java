...
public final class DateChooser extends JPanel {
    ...
    int x = textRefernce.getWidth();  // Lấy chiều rộng của JTextField để căn bên phải
    int y = textRefernce.getHeight();  // Lấy chiều cao của JTextField để căn xuống dưới
    popup.show(textRefernce, x, y);
}
    ...
    private void initComponents() {
        ...
        cmdForward = new ui.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new ui.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new ui.datechooser.Button();
        cmdPrevious = new ui.datechooser.Button();
        slide = new ui.datechooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/datechooser/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/datechooser/previous.png"))); // NOI18N
    ...
    private ui.datechooser.Button cmdForward;
    private ui.datechooser.Button cmdMonth;
    private ui.datechooser.Button cmdPrevious;
    private ui.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private ui.datechooser.Slider slide;
